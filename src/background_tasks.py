...
def run_thread_processing(request: api_models.APISendMessageRequest):
    """
    ...
    services.process_thread_and_create_draft(request)
    print("BACKGROUND_TASK: Thread processing finished.")


def run_feedback_processing(request: api_models.APIProcessFeedbackRequest):
    """
    This function is executed in the background.
